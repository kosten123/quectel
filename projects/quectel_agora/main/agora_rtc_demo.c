...
void agora_main(void)
{
	...
	if (lcd_en) {
		...
		lcd_open.device_name = "st7701s_ql";//"st7796s" "h050iwv" "st7282"
...
void cli_agora_rtc_test_cmd(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
	...
	if (os_strcmp(argv[1], "audio") == 0) {
		...
		if (os_strcmp(argv[2], "start") == 0) {
			...
			} else if (os_strcmp(argv[5], "864X480") == 0) {
				camera_ppi = PPI_864X480;
			} else {
				LOGW("the ppi1 is not support \n");
				goto cmd_fail;
			}
			audio_en = false;
			video_en = true;
		...
		if (os_strcmp(argv[2], "start") == 0) {
			...
			if (os_strcmp(argv[7], "320X240") == 0) {
				...
				camera_ppi = PPI_800X480;
			} else if (os_strcmp(argv[7], "864X480") == 0) {
				camera_ppi = PPI_864X480;
			} else {
				LOGW("the ppi2 is not support \n");
				goto cmd_fail;
			}
